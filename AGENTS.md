...
This project is indexed by GitNexus as **itsaplan** (20813 symbols, 52991 relationships, 479 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/itsaplan/context` | Codebase overview, check index freshness |
| `gitnexus://repo/itsaplan/clusters` | All functional areas |
| `gitnexus://repo/itsaplan/processes` | All execution flows |
| `gitnexus://repo/itsaplan/process/{name}` | Step-by-step execution trace |
